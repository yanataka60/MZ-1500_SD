...
### (2026.8.15追記)多段ロードに対応するためArduinoプログラム及び1Z-009B_SD_Launcher.binを更新しました。
...
#### 　ただし、SDアクセスルーチンがROM上にあるMZ-80K_SD、MZ-700_SDとは違いMZ-1500_SDはRAM上にあるため、１段目のプログラムのロード範囲がC100h以降であるとSDアクセスルーチンを破壊してしまい、多段ロードが機能しません。
