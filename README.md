...
### 汎用SDアクセスルーチン
　MZ-80Kシリーズ、MZ-1200、MZ-700、MZ-1500用アプリケーションへのSDアクセスルーチンの組み込み及び自作アプリケーションのSD対応用としてSDアクセスルーチンを抜き出しました。

　SP-1002、MZ-1Z009B、FN-700モニタを前提としていますので独自モニタではサブルーチンコールを修正する必要があります。
